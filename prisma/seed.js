...
// ── CHANGE THIS ───────────────────────────────────────────────────────────────
const BOOKING_ID = "9fa5dab5-7f9d-4fbf-901a-0ddbfe9a3bb7";
// ─────────────────────────────────────────────────────────────────────────────

const feedback = {
  summary:
    "Asif demonstrated a solid understanding of React fundamentals and component architecture. He approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, he's well on track for a mid-level frontend role.",
  technical:
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — Asif was engaged and receptive to feedback. Would be happy to interview him again after he's done more system design prep.",
};
